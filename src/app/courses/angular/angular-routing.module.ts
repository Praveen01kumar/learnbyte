...
const routes: Routes = [
    { path: routeConfig?.empty, component: DashboardComponent },
    {
        ...
        children: [
            ...
            {
                path: ngTopics?.dependency_injection,
                children: [
            ...
            {
                path: ngTopics?.state_management,
                children: [
            ...
            {
                path: ngTopics?.performance_optimization,
                children: [
            ...
            {
                path: ngTopics?.deployment_module,
                children: [
            ...
            {
                path: ngTopics?.angular_animation,
                children: [
